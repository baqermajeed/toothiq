...
/// بديل موحّد للـ SnackBar بتصميم متناسق مع التطبيق.
abstract final class AppToast {
  ...
  static void show(
    ...
    final (Color bgColor, Color leftColor, IconData icon) = _styleFor(
      type,
      isDark,
    );
    ...
    Get.rawSnackbar(
      ...
      messageText: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(left: BorderSide(color: leftColor, width: 4.w)),
          boxShadow: [
            BoxShadow(
  ...
  static (Color bg, Color left, IconData icon) _styleFor(
    ToastType type,
    bool isDark,
  ) {
