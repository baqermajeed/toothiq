...
class CartConfirmDialog extends StatelessWidget {
  ...
  IconData get _icon => switch (type) {
        CartConfirmType.clearCart => Icons.shopping_basket_outlined,
        CartConfirmType.removeItem => Icons.delete_outline_rounded,
      };
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(_icon, color: _accent, size: 28.sp),
              ),
